...
/** @internal */
declare const getLikes: (options: GetLikesOptions, clientID: string, axiosInstance: AxiosInstance) => Promise<PaginatedQuery<Like>>;
//#endregion
export { GetLikesOptions, Like, getLikes };
//# sourceMappingURL=likes.d.mts.map