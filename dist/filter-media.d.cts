...
/** @internal */
declare const filterMedia: (media: Transcoding[], predicate: FilterPredicateObject) => Transcoding[];
//#endregion
export { FilterPredicateObject, filterMedia as default };
//# sourceMappingURL=filter-media.d.cts.map