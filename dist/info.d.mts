...
/** @internal */
declare const getInfoBase: <T extends TrackInfo | SetInfo>(url: string, clientID: string, axiosRef: AxiosInstance) => Promise<T>;
/** @internal */
declare const getInfo: (url: string, clientID: string, axiosInstance: AxiosInstance) => Promise<TrackInfo>;
/** @internal */
declare const getSetInfo: (url: string, clientID: string, axiosInstance: AxiosInstance) => Promise<SetInfo>;
/** @internal */
declare const getTrackInfoByID: (clientID: string, axiosInstance: AxiosInstance, ids: number[], playlistID?: number, playlistSecretToken?: string) => Promise<TrackInfo[]>;
//#endregion
export { SetInfo, TrackInfo, Transcoding, User, getInfo as default, getInfoBase, getSetInfo, getTrackInfoByID };
