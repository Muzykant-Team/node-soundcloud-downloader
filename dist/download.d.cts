...
declare const getMediaURL: (url: string, clientID: string, axiosInstance: AxiosInstance) => Promise<string>;
declare const getProgressiveStream: (mediaUrl: string, axiosInstance: AxiosInstance) => Promise<any>;
declare const getHLSStream: (mediaUrl: string) => m3u8stream.Stream;
/** @internal */
...
declare const fromURLBase: fromURLFunctionBase;
declare const fromURL: (url: string, clientID: string, axiosInstance: AxiosInstance) => Promise<any | m3u8stream.Stream>;
declare const fromMediaObjBase: (media: Transcoding, clientID: string, getMediaURLFunction: (url: string, clientID: string, axiosInstance: AxiosInstance) => Promise<string>, getProgressiveStreamFunction: (mediaUrl: string, axiosInstance: AxiosInstance) => Promise<any>, getHLSStreamFunction: (mediaUrl: string) => m3u8stream.Stream, fromURLFunction: typeof fromURL, axiosInstance: AxiosInstance) => Promise<any | m3u8stream.Stream>;
declare const fromMediaObj: (media: Transcoding, clientID: string, axiosInstance: AxiosInstance) => Promise<any>;
declare const fromDownloadLink: (id: number, clientID: string, axiosInstance: AxiosInstance) => Promise<any>;
/** @internal */
declare const download: (url: string, clientID: string, axiosInstance: AxiosInstance, useDownloadLink?: boolean) => Promise<any>;
//#endregion
export { download, fromDownloadLink, fromMediaObj, fromMediaObjBase, fromURL, fromURLBase, getHLSStream, getMediaURL, getProgressiveStream };
