...
declare const FORMAT_PRIORITY: FORMATS[];
/** @internal */
declare const _FORMATS: Record<keyof typeof FORMATS, FORMATS>;
/** Check if format is lossless */
declare const isLosslessFormat: (format: FORMATS) => boolean;
/** Check if format is AAC-based (recommended 2026+) */
declare const isAACFormat: (format: FORMATS) => boolean;
/** Check if format requires Go+ Premium */
declare const isPremiumFormat: (format: FORMATS) => boolean;
/** Check if format is deprecated for HLS (Dec 2025) */
declare const isDeprecatedFormat: (format: FORMATS) => boolean;
/** Get recommended format for quality tier */
declare const getFormatForTier: (tier: QUALITY_TIER) => FORMATS;
/** Get bitrate in kbps (0 if unknown/lossless) */
declare const getFormatBitrate: (format: FORMATS) => number;
/** Get best available format from a list of available formats */
declare const getBestFormat: (available: FORMATS[]) => FORMATS | undefined;
/** Compare two formats (for sorting, negative = first is better) */
declare const compareFormats: (a: FORMATS, b: FORMATS) => number;
//#endregion
export { FORMATS, FORMATS as default, FORMAT_PRIORITY, QUALITY_TIER, _FORMATS, compareFormats, getBestFormat, getFormatBitrate, getFormatForTier, isAACFormat, isDeprecatedFormat, isLosslessFormat, isPremiumFormat };
