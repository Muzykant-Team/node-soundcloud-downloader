...
/** @internal */
declare const search: (options: SearchOptions, axiosInstance: AxiosInstance, clientID: string) => Promise<SearchResponseAll>;
/** @internal */
declare const related: <T extends TrackInfo>(id: number, limit: number | undefined, offset: number | undefined, axiosInstance: AxiosInstance, clientID: string) => Promise<RelatedResponse<T>>;
//#endregion
export { RelatedResponse, SearchOptions, SearchResponseAll, SoundcloudResource, related, search };
